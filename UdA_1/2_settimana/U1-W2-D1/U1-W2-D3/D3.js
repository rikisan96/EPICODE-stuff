...
console.log(eyeColor) //mostra oggetto eyeColor

    /* ESERCIZIO 6
    Usa un while loop per calcolare la massa totale dell'equipaggio. Salvala in una variabile chiamata "crewMass".
    */
  let sommaMassa = 0, i=0;
    do {
      sommaMassa += starWarsCharacters[i].mass;
      i++;
    } while (i < starWarsCharacters.length);
  console.log("La massa totale della nave e' di ", sommaMassa, " kg.")
...
*/
  switch (sommaMassa){
    ...
    break;
    case (sommaMassa > 500 && sommaMassa < 700) :
      console.log("Ship is half loaded");
    break;
    case (sommaMassa > 700 && sommaMassa < 900) :
      console.log("Warning: Load is over 700");
    break;
    case (sommaMassa > 900 && sommaMassa < 1000):
      console.log("Critical Load: Over 900");
    break;
    case (sommaMassa > 1000 ):
      console.log("DANGER! OVERLOAD ALERT: escalpe from ship now!");
    break;
    default: ;
  }
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  let genders = starWarsCharacters.filter(this.gender=="n/a")
}
